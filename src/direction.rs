...
pub fn endpoints(d: &Direction) -> ((usize, usize), (usize, usize)) {
    match d {
...
pub fn connected(a: &Direction, b: &Direction) -> bool {
    assert!(a != b);
...
pub fn combine(a: &Direction, b: &Direction) -> Option<Direction> {
    if !connected(a, b) {
        return None;
    }
